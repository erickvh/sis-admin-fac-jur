...
<form action="{{route('memoria-social.store')}}" method="POST">
    {{csrf_field()}}
            ...
            <div class="form-row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" id="fechaInicio" type="date" name="fechaFin">
                  </div>
                </select>
              ...
              <div class="col-md-6">
                ...
                <input class="form-control" id="name" type="text" name="jefe" >
              </div>
            </div>
            </div>
