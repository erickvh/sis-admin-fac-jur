...
<form action="{{route('retiro-materia.store')}}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-4{{ $errors->has('telefono') ? ' has-error' : '' }}">
                ...
                <input class="form-control" id="telefono" type="text" name="telefono" value="{{ old('telefono') }}" autofocus  maxlength="9" required  placeholder="Numero de telefono" onkeyup="guion();" onkeypress="return valida(event)">
